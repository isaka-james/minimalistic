...
$(document).ready(function () {
  function sendEmail(packageName) {
    const email = "isakajames@jasitech.co.tz";
    const subject = `Interested in ${packageName}`;
    const body = `Hello, Isaka James

I am very interested in learning more about the ${packageName} you offer. I would like to understand the following details:

1. What specific services are included in this package?
2. Are there any additional costs or hidden fees associated with the package?
3. Could you provide some case studies or examples of previous work related to this package?
4. What is the expected timeline for delivery after purchase?
5. Are there any discounts available for long-term subscriptions or bundled services?
...
`;
    ...
    // Use a mailto link to simulate sending an email
    window.location.href = `mailto:${email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  }


  $('#securityPackage').click(function () {
    sendEmail('Complete Security Package');
  });

  $('#developmentPackage').click(function () {
    sendEmail('Web & App Development Package');
  });

  $('#designPackage').click(function () {
    sendEmail('Design & UI/UX Package');
  });

  $('#marketingPackage').click(function () {
    sendEmail('Digital Marketing Solutions');
  });
});